...
model_dir = "iic/SenseVoiceSmall"  # 改为使用modelscope模型名称，不使用本地路径
model_senceVoice = AutoModel( model=model_dir, trust_remote_code=True, )

# -------- CAM++声纹识别 -- 模型加载 --------
set_SV_enroll = './SpeakerVerification_DIR/enroll_wav/'  # 使用相对路径，修改分隔符
...
# --------- QWen2.5大语言模型 ---------------
# model_name = "Qwen/Qwen2.5-0.5B-Instruct"  # 使用huggingface模型名称
model_name = "Qwen/Qwen2.5-1.5B-Instruct"  # 使用huggingface模型名称
