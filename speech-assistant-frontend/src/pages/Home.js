...
const features = [
  ...
  {
    title: '场景语音对话',
    description: '同时分析音频和视频，智能理解场景和语音内容，提供上下文相关的回答',
    icon: <VideocamIcon sx={{ fontSize: 60 }} />,
    path: '/scene-voice-chat',
    color: '#8e24aa'
  }
];
          ...
          >
            <CardContent sx={{ flexGrow: 1, pb: 1 }}>
              ...
              <Typography variant="body2" align="center">
                同时分析音频和视频，智能理解场景和语音内容，提供上下文相关的回答
              </Typography>
            </CardContent>
            <CardActions sx={{ justifyContent: 'center', pb: 2 }}>
              <Button variant="contained" color="inherit" sx={{ color: '#8e24aa' }}>
                开始使用
              </Button>
            </CardActions>
          </Card>
